...
!function(e) {
    ...
    function u(e, r, n, i) {
        ...
        try {
            for (var L, R, A = 0;;) {
                if (N.t.lastIndex = A, L = N.t.exec(r), !L)
                    break;
    ...
    function m(e) {
        var t,
            ...
            l,
            m = i(e);
        n(m) || (S.useBR ? (t = document.createElementNS("https://www.w3.org/1999/xhtml", "div"), t.innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n")) : t = e, l = t.textContent, a = m ? u(m, l, !0) : d(l), r = c(t), r.length && (s = document.createElementNS("https://www.w3.org/1999/xhtml", "div"), s.innerHTML = a.value, a.value = o(r, c(s), l)), a.value = b(a.value), e.innerHTML = a.value, e.className = p(e.className, m, a.language), e.result = {
            language: a.language,
            re: a.r
